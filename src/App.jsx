...
import { ExternalLink, Download, Send, Menu, X, Sparkles } from 'lucide-react';
...
export default function App() {
  ...
  // Positions outer images further out at scroll start, converging into position as you scroll
  ...
  // Form submit handler connecting to Node/MongoDB backend
  ...
  return (
    // <div className="min-h-screen bg-[#0a0c10] text-slate-100 font-sans selection:bg-indigo-500 selection:text-white">
    <div className="relative min-h-screen bg-[#0d0714] text-slate-100 font-sans selection:bg-purple-500 selection:text-white overflow-hidden">
     
      {/* 1. APPLE-STYLE GLASSMORPHISM NAVBAR */}
      ...
      {activePage === 'home' ? (
        <main className="pt-28">
          ...
          <section
            id="about"
            className="py-20 px-4 max-w-5xl mx-auto border-t border-slate-800/80"
          >
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="relative group">
                ...
                <img
                  ...
                  className="relative rounded-2xl w-full h-96 object-cover bg-slate-800"
                />
              </div>
              <div className="space-y-4">
                ...
                <p className="text-slate-400 leading-relaxed">
                  I create visual content that tells stories, builds brands, and
                  leaves a lasting impression. With a passion for editing,
                  design, and creative storytelling, I help brands and
                  individuals turn their ideas into powerful visuals.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="max-w-5xl mx-auto px-4 space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    { name: 'Premiere Pro', desc: 'Video Editing', icon: 'Pr' },
                    { name: 'Photoshop', desc: 'Graphic Design', icon: 'Ps' },
                    { name: 'Illustrator', desc: 'Vector Art', icon: 'Ai' },
                    { name: 'Figma', desc: 'UI/UX Prototyping', icon: 'Fi' },
                  ].map((tool, idx) => (
                    <motion.div
                      key={idx}
                      whileHover={{ y: -5 }}
                      className="p-4 rounded-xl bg-slate-900 border border-slate-800 hover:border-indigo-500/50 flex items-center gap-3"
                    >
                      <div className="w-10 h-10 rounded-lg bg-indigo-950/80 border border-indigo-500/30 flex items-center justify-center font-bold text-indigo-400">
                        {tool.icon}
                      </div>
                      <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    ...
                    <motion.div
                      ...
                      className="p-3 text-center rounded-lg bg-slate-900/60 border border-slate-800 text-slate-300 font-medium text-sm"
                    >
                      {tech}
                    </motion.div>
                  ))}
        ...
        /* 2. DYNAMIC WORK PAGE WITH EXPANDING/CONVERGING SCROLL ANIMATION */
          ...
          <div className="flex items-center space-x-4">
            {[
              ...
              { icon: <FaFacebookF size={18} />, href: 'https://facebook.com' },
              {
                ...
                href: 'https://wa.me/8086575494',
              },
              { icon: <FaBehance size={18} />, href: 'https://www.behance.net/jeffinjames' },
              {
                icon: <FaLinkedinIn size={18} />,
                href: 'www.linkedin.com/in/jeffin-james'
                ,
              },
            ].map((social, idx) => (
              <motion.a
                ...
                className="w-9 h-9 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-indigo-500/50 transition-colors"
              >
                {social.icon}
              </motion.a>
            ))}
