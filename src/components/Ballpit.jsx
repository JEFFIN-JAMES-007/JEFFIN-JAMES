...
class x {
  ...
  #p() {
    ...
    const e = {
      ...
      alpha: true, // Enables transparent WebGL canvas
      ...(this.#e.rendererOptions ?? {})
    };
    this.renderer = new s(e);
    this.renderer.outputColorSpace = n;
    this.renderer.setClearColor(0x000000, 0); // Sets background clear color opacity to 0
  }
  #g() {
  ...
  dispose() {
    ...
    // Removed forceContextLoss() to prevent breaking React StrictMode re-mounts
